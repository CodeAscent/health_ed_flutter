          ...
          Padding(
            ...
            child: GridView.count(
              ...
              children: [
                ...
                _buildGridButton('How to get best\nresults!', Icons.menu_book, Color(0xFF01D15F), 3, userData),
...
Widget _buildGridButton(String title, IconData icon, Color color, int gridNo, userData) {
  return Padding(
    ...
    child: ElevatedButton(
      ...
      onPressed: () {
        if ((gridNo == 1 || gridNo == 2) && userData['onboardingScore'] == 0) {
          Get.snackbar(
...
Widget buildImage(Map<String, dynamic> userData) {
  ...
  final String paymentStatus = userData['assessmentPaymentStatus'] ?? 'unpaid';
  final bool isTeacherEvaluationCompleted = userData['isTeacherEvaluationCompleted'] ?? false;
