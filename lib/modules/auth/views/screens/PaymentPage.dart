  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        ...
        } else if (state is CreatePaymentOrderSuccess) {
          orderId = state.resCreateOrder.data!.orderId!;
          var options = {
            'key': state.resCreateOrder.data!.key,
            'order_id': state.resCreateOrder.data!.orderId,
            'amount': state.resCreateOrder.data!.amount,
            'name': 'TheDhwani',
